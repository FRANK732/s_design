...
class SInputFieldThemeData
    extends ThemeExtension<SInputFieldThemeData> {
  ...
  factory SInputFieldThemeData.fromColorScheme(ColorScheme colorScheme) {
    return SInputFieldThemeData(
      backgroundColor: colorScheme.surface,
      borderColor: colorScheme.outline,
      focusedBorderColor: colorScheme.primary,
      errorBorderColor: colorScheme.error,
      disabledBorderColor: colorScheme.onSurface.withOpacity(0.38),
  ...
  SInputFieldThemeData lerp(
      ThemeExtension<SInputFieldThemeData>? other, double t) {
