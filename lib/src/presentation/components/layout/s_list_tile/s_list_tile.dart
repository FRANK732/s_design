...
class SListTile
  ...
  Widget build(
    ...
    Widget
      ...
      title:
        ...
        style: titleTextStyle ??
            ...
            theme.textTheme.titleMedium!.copyWith(
              ...
              fontSize: 14,
              color: showLoading ? Colors.transparent : (enabled ? textColor ?? theme.colorScheme.onSurface : (textColor ?? theme.colorScheme.onSurface).withOpacity(0.5)),
            ),
        child: title,
      ),
      // Subtitle
          ...
          ? AnimatedDefaultTextStyle(
              ...
              style: subtitleTextStyle ??
                  ...
                  theme.textTheme.bodySmall!.copyWith(
                    color: showLoading ? Colors.transparent : (enabled ? textColor ?? theme.colorScheme.onSurfaceVariant : (textColor ?? theme.colorScheme.onSurfaceVariant).withOpacity(0.5)),
                  ),
              child: subtitle!,
            )
          : null,
      ...
      tileColor: showLoading
          ...
          : (tileColor ?? listTileTheme.tileColor ?? theme.scaffoldBackgroundColor),
      selectedTileColor:
          selectedTileColor,
      iconColor:
          iconColor,
      ...
      focusColor:
          focusColor ?? theme.colorScheme.primary.withOpacity(0.3),
      horizontalTitleGap:
          horizontalTitleGap,
      minVerticalPadding:
          minVerticalPadding,
  ...
  Widget
    ...
    if (badge ==
      ...
      return IconTheme(
        data: IconThemeData(
          color: showLoading ? Colors.transparent : (enabled ? iconColor ?? listTileTheme.iconColor ?? iconTheme.color : (iconColor ?? listTileTheme.iconColor ?? iconTheme.color)?.withOpacity(0.5)),
          size: iconTheme.size,
        ),
        child: leading,
      );
    ...
    return SizedBox(
      width:
          (iconTheme.size ?? 24.0) + 16.0, // Space for badge
      child:
          Stack(
