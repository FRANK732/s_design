...
class SDropdownMenu<
  ...
  final double?
      menuItemPadding;
  final SDropdownMenuItemType
      menuType;
  final Duration
      animationDuration;
  final Curve
      animationCurve;
  final SDropdownMenuPosition
      preferredPosition;
  final STriggerContainerSize
      triggerSize;
  final bool
...
class _SDropdownMenuState<
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Material(
                  elevation: widget.menuElevation ?? theme.cardTheme.elevation ?? 4,
                  color: widget.menuBackgroundColor ?? theme.cardColor,
                  shape: widget.menuShape ??
                      RoundedRectangleBorder(
                        borderRadius: widget.menuBorderRadius ?? BorderRadius.circular(8),
                      ),
                  child: AnimatedContainer(
                    duration: widget.animationDuration,
                    curve: widget.animationCurve,
                    padding: widget.menuContentPadding ?? widget.menuPadding ?? const EdgeInsets.all(8),
  ...
  double
    ...
    double
        baseHeight =
        _filteredItems.length * (widget.menuItemHeight ?? 48.0);
    if (widget.menuType ==
        SDropdownMenuItemType.searchable) {
      baseHeight +=
          64;
    }
    return baseHeight;
          ...
          child: Focus(
            ...
            child: Container(
              ...
              child: AnimatedContainer(
                ...
                decoration: widget.triggerDecoration ??
                    BoxDecoration(
                      color: widget.backgroundColor ?? theme.inputDecorationTheme.focusColor,
                      borderRadius: BorderRadius.circular(widget.borderRadius ?? 8),
                      border: widget.triggerBorder,
                      gradient: widget.triggerGradient,
                      shape: widget.triggerShape != null ? BoxShape.rectangle : BoxShape.rectangle,
                    ),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                      ...
                      child: widget.menuType == SDropdownMenuItemType.multiSelect
                          ? _selectedItems.isEmpty
                              ? Text(
                                  ...
                                  style: widget.hintTextStyle ?? widget.textStyle ?? theme.textTheme.bodyMedium,
                    ...
                    if (widget.showMenuIcon)
                      Align(
                        alignment: widget.triggerIconAlignment ?? Alignment.centerRight,
  ...
  Widget
    ...
    final ThemeData
        theme =
        Theme.of(context);
    STriggerContainerSizeUtils.getChipHeight(
        widget.triggerSize);
    STriggerContainerSizeUtils.getChipWidth(
        widget.triggerSize);
    final EdgeInsetsGeometry
        chipPadding =
        ...
        .map(
          (T item) => Padding(
            ...
            child: Chip(
              ...
              deleteIcon: widget.chipDeleteIcon ?? Icon(Icons.close, size: chipIconSize),
              onDeleted: () {
                setState(() {
                  _selectedItems.remove(item);
                  widget.onChanged(_selectedItems);
