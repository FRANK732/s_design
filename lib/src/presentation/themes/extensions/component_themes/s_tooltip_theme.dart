...
class STooltipThemeData extends ThemeExtension<STooltipThemeData> {
  ...
  @override
  STooltipThemeData lerp(ThemeExtension<STooltipThemeData>? other, double t) {
    if (other is! STooltipThemeData) return this;
    return STooltipThemeData(
      ...
      arrowSize: arrowSize + (other.arrowSize - arrowSize) * t,
...
extension STooltipThemeExtension on ThemeData {
