...
class SFloatingPanel {
  ...
  static bool get isPanelOpen => _isPanelOpen;
  ...
  static Widget? _currentContent;
  static Widget? _currentBottomWidget;
  static GlobalKey _contentKey = GlobalKey();
  static GlobalKey _bottomWidgetKey = GlobalKey();
  ...
  static Future<void> show({
    ...
    assert(bottomMargin >= 0, 'Bottom margin must be non-negative');
    assert(panelSpacing >= 0, 'Panel spacing must be non-negative');
    ...
    _currentBottomWidget = customBottomWidget;
    ...
    if (_isPanelOpen && _overlayEntry != null && _animationController != null) {
    ...
    _animationController!.addStatusListener((AnimationStatus status) {
      dev.log('Animation status: $status', name: 'SFloatingPanel');
    });
    ...
    _overlayEntry = OverlayEntry(
      builder: (BuildContext overlayContext) => PopScope(
        canPop: false,
  ...
  static Future<void> _measureWidgetSizes() async {
    ...
    if (bottomRenderBox != null) {
      dev.log('Bottom widget height: ${bottomRenderBox.size.height}',
          name: 'SFloatingPanel');
    }
  }

  static Future<void> _closePanel(AnimationController? animationController,
  ...
  static Future<void> close() async {
    ...
    await _closePanel(_animationController, _completer);
  }
}
