...
class SButtonSelectGroup
  ...
  const SButtonSelectGroup.single({
    ...
    ValueChanged<Set<int>>?
        onChanged,
    required List<SButtonSelectGroupItem>
        children,
  ...
  final SButtonSelectMode
      mode;
  final Set<int>
      initialSelection;
  final ValueChanged<Set<int>>?
      onChanged;
  final List<SButtonSelectGroupItem>
      children;
  ...
  void _onItemTapped(
    ...
    switch (
      ...
      case SButtonSelectMode.multi:
        final Set<int> mutable = Set<int>.from(_selected);
  ...
  Widget build(
    ...
    if (widget
      ...
      return Column(
        ...
        children: _buildItems(fullWidth: true),
      );
    }
  ...
  List<Widget>
    ...
    for (int i = 0;
      ...
      final Widget
          btn =
          SButtonSelectable(
        key: item.key ?? ValueKey<String>('s_select_group_item_$i'),
        isSelected: isSelected,
        onSelectionChanged: isDisabled ? null : (_) => _onItemTapped(i),
        config: effectiveConfig,
        variant: widget.variant,
        size: widget.size,
        state: isDisabled ? SButtonState.disabled : null,
