...
import '../../../domain/entities/config/s_loading_types.dart';
import '../../themes/extensions/component_themes/s_loading_indicator_theme.dart';
...
class SLoadingIndicator
  ...
  @override
  State<SLoadingIndicator>
      createState() =>
          _SLoadingIndicatorState();
}

class _SLoadingIndicatorState
    extends State<
        SLoadingIndicator>
    with
      ...
      switch (type) {
        case SLoaderType.chasingDots:
          return SpinKitChasingDots(
            ...
            duration: Duration(milliseconds: (1000 / widget.spinnerSpeed).round()),
          );
  ...
  Widget build(
    ...
    final TextStyle
        messageStyle =
        widget.messageStyle ?? theme.messageStyle.copyWith(color: widget.messageColor);
            ...
            if (widget.showBackground)
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  color: widget.backgroundColor?.withOpacity(widget.backgroundOpacity) ?? Colors.black.withOpacity(widget.backgroundOpacity),
                ),
              ),
            Center(
              child: Semantics(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: theme.useGradient
                        ...
                        : null,
                    color: theme.useGradient ? null : (widget.backgroundColor ?? Colors.white),
