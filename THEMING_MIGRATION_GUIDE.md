...
Version 0.3.2+1 introduces a **production-ready centralized theming system** for all sDesign components. This guide helps you migrate from the previous implementation to the new theming system.
