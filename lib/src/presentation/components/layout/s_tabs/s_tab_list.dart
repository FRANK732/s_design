...
class STabsList
  ...
  void
    ...
    // Validate tabWidth
    if (tabWidth != null &&
        (tabWidth! <= 0 || tabWidth!.isInfinite)) {
      throw FlutterError(
    ...
    if (maxTabWidth != null &&
        (maxTabWidth! <= 0 || maxTabWidth!.isInfinite)) {
      throw FlutterError(
    ...
    if (animationDuration.inMilliseconds <=
        0) {
  ...
  Widget build(
    ...
    final STabs?
        widgetTabs =
        context.findAncestorWidgetOfExactType<STabs>();
    if (widgetTabs != null &&
