...
class STabs
  ...
  const STabs({
    ...
    this.initialIndex =
        0,
    this.animationType =
        STabAnimationType.fade,
    this.duration =
        const Duration(milliseconds: 300),
    this.curve =
        Curves.easeInOut,
    this.orientation =
        STabOrientation.horizontal,
    ...
    this.tabListMargin =
        EdgeInsets.zero,
    this.tabListPadding = const EdgeInsets
        .all(
        3.0),
    ...
    this.tabPadding = const EdgeInsets
        .symmetric(
        vertical: 3,
        horizontal: 55),
    this.tabMargin = const EdgeInsets
        .symmetric(
        horizontal: 5.0,
        vertical: 2.0),
    this.tabWidth =
  ...
  Widget build(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        STabsList(
          direction: widget.orientation == STabOrientation.horizontal ? Axis.horizontal : Axis.vertical,
